...
class Freelancer extends Component {
    ...
    render() {
        ...
        var country = user.country || "No especificado";
                        ...
                        <div className="row">
                                ...
                                <div className="col-lg-12">
                                    <div className="row">
                                        ...
                                        <div className="col" style={{ padding: 0 }}>
                                            <p style={{ fontSize: '1.3em', margin: 0 }} className="text-dark">{user.displayName || <br />}</p>
                                            <p style={{ fontSize: '0.8em', opacity: '0.5' }} className="text-secondary">Programador senio</p>
                                        </div>
                                    </div>
                                </div>
                                {/*Descripcion*/}
                            ...
                            <div className="col-lg-4">
                                ...
                                <div className="col-sm-12" style={{ marginTop: 5 }}>
                                    ...
                                    <p style={{ fontSize: '0.8em', margin: 0, display: 'flex', justifyContent: 'space-between' }} className="text-dark">País: <a href="#!" className="text-muted">{country}</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
